...
public  void logimForAll(String userName,String email,String password){
    ...
    passwordBox.sendKeys(password);
        ...
        WebElement Logged in as = Driver.get().findElement(By.xpath("//a[text()=' Logged in as: " + ConfigurationReader.get("userName") + "']"));
        BrowserUtils.waitForVisibility(Logged in as ,5);
        Assert.assertTrue(Logged in as .getText().contains(ConfigurationReader.get("userName"))); */
    }
